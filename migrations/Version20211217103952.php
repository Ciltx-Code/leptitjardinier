 ...
 */
final class Version20211217103952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE devis (id INT AUTO_INCREMENT NOT NULL, cif2_id INT DEFAULT NULL, date DATE NOT NULL, INDEX IDX_8B27C52BDD997971 (cif2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE devis ADD CONSTRAINT FK_8B27C52BDD997971 FOREIGN KEY (cif2_id) REFERENCES client (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis DROP FOREIGN KEY FK_8B27C52BDD997971');
