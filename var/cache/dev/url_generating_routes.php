...
return [
    ...
    'd_index' => [[], ['_controller' => 'App\\Controller\\DController::index'], [], [['text', '/d/']], [], []],
    'd_new' => [[], ['_controller' => 'App\\Controller\\DController::new'], [], [['text', '/d/new']], [], []],
    'd_show' => [['id'], ['_controller' => 'App\\Controller\\DController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/d']], [], []],
    'd_edit' => [['id'], ['_controller' => 'App\\Controller\\DController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/d']], [], []],
    'd_delete' => [['id'], ['_controller' => 'App\\Controller\\DController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/d']], [], []],
    'devis' => [[], ['_controller' => 'App\\Controller\\DevisController::index'], [], [['text', '/devis']], [], []],
