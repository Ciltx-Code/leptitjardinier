 ...
 */
class getHaieDevisRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HaieDevisRepository' shared autowired service.
     *
     * @return \App\Repository\HaieDevisRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HaieDevisRepository.php';

        return $container->privates['App\\Repository\\HaieDevisRepository'] = new \App\Repository\HaieDevisRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
