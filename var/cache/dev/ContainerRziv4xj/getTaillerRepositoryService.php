 ...
 */
class getTaillerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TaillerRepository' shared autowired service.
     *
     * @return \App\Repository\TaillerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TaillerRepository.php';

        return $container->privates['App\\Repository\\TaillerRepository'] = new \App\Repository\TaillerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
