 ...
 */
class getHaieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HaieRepository' shared autowired service.
     *
     * @return \App\Repository\HaieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HaieRepository.php';

        return $container->privates['App\\Repository\\HaieRepository'] = new \App\Repository\HaieRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
